...
public class HmacTest {
    ...
    @Test
    public void testHmacEncoder1() {
        byte[] hmacSha256 = Hmac.encodeHmac(Keys.KEY, utils1.longToBytes(1));
        System.out.printf("Hex: %032x%n", new BigInteger(1, hmacSha256));
        Assert.assertEquals("4585ca889a1ea41c33064977b9584caba13dc95d633497deed2eb413e072ee0d", String.format("%032x", new BigInteger(1, hmacSha256)));
    }
